 ...
 * @extends {ActorSheet}
 */
export class Pokemonta3ActorSheet extends ActorSheet {
  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ['pokemonta3', 'sheet', 'actor'],
      width: 600,
      height: 600,
      tabs: [
        {
  ...
  /** @override */
  get template() {
    return `systems/pokemonta3/templates/actor/actor-${this.actor.type}-sheet.hbs`;
  }
  ...
  getData() {
    ...
    context.optionObj = CONFIG.pokemonta3.dropdownChoices;
  ...
  /**
   * Organize and classify Items for Trainer sheets.
   *
